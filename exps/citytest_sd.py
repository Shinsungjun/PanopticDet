...
class Exp(BaseExp):
    ...
    def get_model(self):
        ...
        if getattr(self, "model", None) is None:
            ...
            seghead = SegHead()
            self.model = Fullmodel(backbone=backbone, neck=neck, detecthead=detecthead, seghead=seghead, depthhead=depthhead)
    ...
    def get_data_loader(
        ...
        from engine.utils import (
            wait_for_the_master,
            get_local_rank,)
        from engine.data.datasets.city_sd import Cityscapes, collate_fn
